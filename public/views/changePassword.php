                                ...
                                <section class="ContainerBox">
                                    ...
                                    <form class="Login-form">
                                        <div class="Input-container">
                                            <input class="Input_input" type="text" name="usernameLog" placeholder="Old password" required="">
                                        </div>
                                        <div class="Input-container">
                                            <input class="Input_input" type="text" name="passwordLogin" placeholder="New password" required="">
                                        </div>
                                        <div class="Input-container">
                                            <input class="Input_input" type="text" name="passwordLogin" placeholder="New password" required="">
                                        </div>
                                        <div class="Login-formOptions">
                                            <button class="ButtonConfirm" type="button">
                                                CONFIRM
                                            </button>
